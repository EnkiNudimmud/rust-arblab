...
try:
    from . import pair_discovery_pb2  # type: ignore[import-not-found]
    from . import pair_discovery_pb2_grpc  # type: ignore[import-not-found]
except ImportError:
    # Fallback for direct execution
    import pair_discovery_pb2  # type: ignore[import-not-found]
    import pair_discovery_pb2_grpc  # type: ignore[import-not-found]
